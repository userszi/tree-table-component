...
export default function CarouselControls({
  ...
  return (
    <div className="flex flex-col items-center space-y-2 bg-slate-800/90 backdrop-blur-sm rounded-lg p-2 border border-slate-600">
      ...
      {/* 添加闪烁的提示标识在下方 */}
      <div className="blink text-xs text-yellow-400 font-semibold">
        点击按钮或圆点·切换股票，自动播放间隔为30秒。
      </div>
    </div>
  )
}
